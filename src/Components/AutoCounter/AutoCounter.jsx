                ...
                <MDBCard>
                  ...
                  <MDBCardBody>
                    <div className="flex justify-between items-center gap-16">
                      <div className="col-3">
                        <h3 className="text-2xl font-bold text-center mb-5 bg-yellow-300 text-black rounded-md">Teachers</h3>
                      ...
                      <div className="col-3">
                        <h3 className="text-2xl font-bold text-center mb-5 bg-yellow-300 text-black rounded-md">Million Graduates</h3>
                        <div className=" bg-slate-500 p-5 rounded-md">
                      ...
                      <div className="col-3">
                        <h3 className="text-2xl font-bold text-center mb-5 bg-yellow-300 text-black rounded-md">Admissions</h3>
                        <div className=" bg-slate-500 p-5 rounded-md">
                      ...
                      <div className="col-3">
                        <h3 className="text-2xl font-bold text-center mb-5 bg-yellow-300 text-black rounded-md">Countries</h3>
                        <div className=" bg-slate-500 p-5 rounded-md">
