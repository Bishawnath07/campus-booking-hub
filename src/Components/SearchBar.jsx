...
const SearchBar = () => {
  ...
  return (
    <form>
      ...
      <input type="submit" onClick={() => handleSearch()} className="border lg:px-10 px-3 py-[7px] bg-image text-black border-[#f36b3b]text-white rounded absolute lg:right-[335px] right-10 lg:w-[200px] w-[35%]" name="" value="Search College" id="" />
      </div>
    </form>
  );
};
